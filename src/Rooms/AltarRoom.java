...
public class AltarRoom extends Room{
	...
	public void enterRoom(Person x)
	{
		...
		if (random<.1) {
			System.out.println("The gods smile upon you. You are healed for 10% of your health.");
			x.setHP(x.getHP()+(int)(x.getMaxHP()*0.1));
		} else if (random<.2) {
			...
			System.out.println("The gods are angry with you. You are smited for 50% of your health.");
			x.setHP(x.getHP() - (int)(x.getMaxHP()*0.5));
		} else if (random<.7) {
